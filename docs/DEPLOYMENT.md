...
| `ADMIN_EMAIL_ALLOWLIST` | Comma-separated emails that get `is_staff=true` **at registration only**. No built-in default — if unset, nobody is auto-promoted to staff. |
