...
export const emptyStates = {
  ...
  studentBookings: {
    active: {
      ...
      body: 'Confirmed stays and guide sessions you have booked will appear here.',
      tip: 'This tab tracks your bookings only — search and discovery live under Explore.',
      iconGlyph: '📅',
    } satisfies EmptyStateContent,
    pending: {
      title: 'No pending requests',
      body: 'Requests waiting for a host or guide reply will appear here.',
      tip: 'Nothing is awaiting a response right now.',
      iconGlyph: '📩',
    } satisfies EmptyStateContent,
    past: {
      title: 'No past bookings',
      body: 'Finished, declined, and cancelled bookings will gather here.',
      tip: 'After a completed stay, you can leave a review from the booking details.',
      iconGlyph: '🧳',
    } satisfies EmptyStateContent,
  },
  hostListings: {
  ...
  lodgingDirectory: (city: string): EmptyStateContent => ({
    ...
    body: 'No hotels, hostels, or lodging partners are listed for this city yet. Try another destination, or check back as partners join NestBridge.',
    tip: 'Partner guesthouses often sit near universities and business districts.',
    iconGlyph: '🏨',
    primaryActionLabel: 'Clear filters',
  }),
  lodgingDirectoryFiltered: (city: string): EmptyStateContent => ({
  ...
  exploreStays: (city: string): EmptyStateContent => ({
    title: `No listings found near ${city} yet`,
    body: 'Host families are still joining NestBridge. Try another city, or check back soon.',
