...
INSERT INTO video_resources (video_id, video_key, title, description, category, youtube_id, thumbnail_url, city, sort_order) VALUES
  ('c0000001-0000-4000-8000-000000000001', 'arrival-tips', 'Arriving in Ghana — What to Expect', 'Visa, SIM cards, money, safety, and practical tips before you land at Kotoka.', 'Orientation', 'ejJcat0HzQQ', 'https://img.youtube.com/vi/ejJcat0HzQQ/hqdefault.jpg', 'Accra', 1),
  ('c0000001-0000-4000-8000-000000000002', 'trotro-safety', 'Getting Around Accra', 'Neighborhoods, landmarks, and how visitors move through Ghana''s capital.', 'Transport', '7-VI47c0Q4A', 'https://img.youtube.com/vi/7-VI47c0Q4A/hqdefault.jpg', 'Accra', 2),
  ('c0000001-0000-4000-8000-000000000003', 'homestay-etiquette', 'Accra Culture, Food & Safety Tips', 'First-trip culture notes, food moments, and safety awareness for visitors.', 'Culture', 'Gjd_rKh5o64', 'https://img.youtube.com/vi/Gjd_rKh5o64/hqdefault.jpg', 'Accra', 3),
  ('c0000001-0000-4000-8000-000000000004', 'accra-orientation', 'Accra Neighborhood Guide', 'Black Star Square, Jamestown, and getting oriented in the capital.', 'Orientation', '8JLOminF2Do', 'https://img.youtube.com/vi/8JLOminF2Do/hqdefault.jpg', 'Accra', 4),
  ('c0000001-0000-4000-8000-000000000005', 'market-tips', 'Street Food & Markets in Accra', 'Chop-bar lunch and West African food markets — useful before you explore with hosts.', 'Culture', 'YvlYjLPgrCE', 'https://img.youtube.com/vi/YvlYjLPgrCE/hqdefault.jpg', 'Accra', 5),
  ('c0000001-0000-4000-8000-000000000006', 'food-intro', 'Introduction to Ghanaian Food', 'Must-try Accra dishes — jollof, banku, and local favorites.', 'Food', 'Yk4cpG1BOHg', 'https://img.youtube.com/vi/Yk4cpG1BOHg/hqdefault.jpg', 'Accra', 6);
